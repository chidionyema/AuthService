...
namespace auth.Services
{
    public class AuthService
    {
        ...
        public async Task RevokeToken(string tokenValue, string userId, DateTime expiryDate)
        {
            ...
            _AuthContext.RevokedTokens.Add(new RevokedToken
            {
                Id = Guid.NewGuid(),
                Token = tokenValue,
                UserId = userId,
        ...
        public async Task RevokeRefreshTokensForUserAsync(string userId)
        {
            ...
            var userRefreshTokens = await _AuthContext.RefreshTokens
            ...
            if (userRefreshTokens.Any())
            {
                ...
                _AuthContext.RefreshTokens.RemoveRange(userRefreshTokens);
                await _AuthContext.SaveChangesAsync();
        ...
        public async Task<bool> IsTokenRevoked(string tokenValue)
        {
            ...
            bool isRevoked = await _AuthContext.RevokedTokens.AnyAsync(rt => rt.Token == tokenValue);
